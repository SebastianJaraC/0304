 ...
 * @author andyj
 */
public class CantonEliminar extends javax.swing.JFrame {

      private CantonControl cantonControl = new CantonControl();

    public CantonEliminar() {
        initComponents();
    }
  ...
  public void actualizarTabla() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CantonEliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CantonEliminar().setVisible(true);
            }
        });
    }
