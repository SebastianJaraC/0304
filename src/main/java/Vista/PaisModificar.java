 ...
 * @author andyj
 */
public class PaisModificar extends javax.swing.JFrame {

    private PaisControl paisControl = new PaisControl();
     
    public PaisModificar() {
        initComponents();
    }
  ...
  public void ActualizarTabla() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaisModificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaisModificar().setVisible(true);
            }
        });
    }
